using System; using System.Collections; using TMPro; using UnityEngine; using Yarn.Unity;
...
public class VisualCommunication : MonoBehaviour {
    ...
    public void StartAddingWords() { if (text == null || npctext == null || npctext.texts == null) { return; }
    ...
    public IEnumerator AddSentenceLetters(string sentence, int counter) { if (text == null) { yield break; }
...
public static class DialogueState {
    ...
    public static bool IsConversationRunning {
        get { if (VisualCommunication.IsTalking) { return true; }

            if (!TryGetDialogueRunner(out DialogueRunner runner)) { return false; }

            return runner.IsDialogueRunning; } }
    public static void RegisterDialogueRunner(DialogueRunner dialogueRunner) { if (dialogueRunner == null) { return; }
