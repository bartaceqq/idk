using System; using System.Collections.Generic; using System.Reflection; using UnityEngine; using UnityEngine.InputSystem; using UnityEngine.Rendering;
...
public static class GameSettings {
    ...
    public static void ApplyGraphicsPreset(int presetIndex) {
        SetGraphicsPresetValues(presetIndex);
        ApplyGraphicsSettings(); }
    ...
    public static void ApplyInputOverrides(UnityEngine.InputSystem.PlayerInput playerInput) { if (playerInput == null || playerInput.actions == null) { return; }
    ...
    public static string ToDisplayName(KeyCode keyCode) { if (keyCode >= KeyCode.Alpha0 && keyCode <= KeyCode.Alpha9) { return ((int)(keyCode - KeyCode.Alpha0)).ToString(); }
    ...
    public static string[] QualityNames() {
        ...
        Array.Copy(GraphicsPresetNames, names, GraphicsPresetNames.Length);
        return names; }
    ...
    private static int ClosestAntiAliasing(int requested) { if (requested <= 0) { return 0; }
    ...
    private static string ToKeyboardPath(KeyCode keyCode) { if (keyCode >= KeyCode.A && keyCode <= KeyCode.Z) { return "<Keyboard>/" + keyCode.ToString().ToLowerInvariant(); }
    ...
    private static void SetPropertyIfPresent(object target, string propertyName, object value) {
        ...
        try {
            property.SetValue(target, value, null); } catch (Exception) {
    ...
    private static string NicifyKeyName(string raw) { if (string.IsNullOrEmpty(raw)) { return string.Empty; }
    ...
    [Serializable] public struct ResolutionChoice : IEquatable<ResolutionChoice> {
