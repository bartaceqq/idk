...
{
    private Terrain terrain; private int detailIndex; private int cellX; private int cellZ;
    private bool suppressClear; private TerrainDetailPickupSpawner spawner;
    ...
    {
        terrain = sourceTerrain; detailIndex = detailPrototypeIndex; cellX = detailCellX;
        cellZ = detailCellZ; spawner = owner; suppressClear = false;
    }
    ...
    private void OnDestroy() { if (suppressClear) { return; } }
}
