...
public class TreeHandler : MonoBehaviour {
	...
	public int test;    
    [Header("Parts")] public float timetowaittodestroy = 8f;
    ...
    public void TreeFall(Transform attacker) { if (toppart == null) { return; }
    ...
    private void TiltTopPartTowardDirection(Transform topTransform, Vector3 fallDirection) { if (topTransform == null) { return; }
    ...
    private void AddFallImpulse(Rigidbody topRigidbody, Vector3 fallDirection) { if (topRigidbody == null) { return; }
    ...
    private void SpawnChopImpact(Transform attacker) { if (chopImpactParticlePrefab == null) { return; }
    ...
    private Vector3 ResolveTreeImpactPoint(Vector3 attackerPosition) { if (bottompart != null && TryResolveClosestImpactPoint(bottompart.transform, attackerPosition, out Vector3 closestImpactPoint)) { return closestImpactPoint; }
    ...
    private static Vector3 ResolveAttackerPosition(Transform attacker, Vector3 fallbackTreePoint) { if (attacker != null) { return attacker.position; }
    ...
    private void PrepareTopPartCollidersForFall(Transform topTransform) { if (topTransform == null) { return; }
    ...
    private static void ReplaceCapsuleColliderForFall(CapsuleCollider capsuleCollider, PhysicsMaterial noRollMaterial) { if (capsuleCollider == null || !capsuleCollider.enabled || capsuleCollider.isTrigger) { return; }
    ...
    private static bool TryEnsureConvexMeshCollider(GameObject target, PhysicsMaterial noRollMaterial) { if (target == null) { return false; }
    ...
    private static bool TryEnsureFallbackBoxCollider(Transform target, PhysicsMaterial noRollMaterial) { if (target == null || !TryGetLocalBounds(target, out Bounds localBounds)) { return false; }
    ...
    private void IgnoreOwningTreeColliders(Transform fallingTop) { if (fallingTop == null) { return; }
    ...
    private void ConfigureTopPartRigidbody(Rigidbody topRigidbody) { if (topRigidbody == null) { return; }
    ...
    private void ConfigureGroundDespawnOnTopPart() { if (toppart == null) { return; }
    ...
    private static PhysicsMaterial ResolveNoRollMaterial() { if (fallbackNoRollMaterial != null) { return fallbackNoRollMaterial; }
    ...
    private static void PlayImpactParticleSystems(GameObject impactInstance) { if (impactInstance == null) { return; }
...
sealed class TreeTopGroundDespawn : MonoBehaviour {
    ...
    private void TryScheduleDespawn(Collision collision) { if (despawnScheduled || !IsGroundHit(collision)) { return; }

        despawnScheduled = true;
        Destroy(gameObject, despawnDelaySeconds); }

    private bool IsGroundHit(Collision collision) { if (collision == null || collision.collider == null || collision.contactCount <= 0) { return false; }
