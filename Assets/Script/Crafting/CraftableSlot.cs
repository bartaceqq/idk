...
public class CraftableSlot : MonoBehaviour, IPointerClickHandler
{
    ...
    private Button slotButton; private Color defaultBackgroundColor;
    ...
    public void AddCraftableItem(CraftableItem craftableItem)
    {
        ...
        imageslot.sprite = craftableItem.sprite; craftableItemReference = craftableItem;
        name = craftableItem.name; occupied = true;
        neededResources = craftableItem.neededResources; if (levelingManager == null)
        {
            locked = false;
        }
    ...
    public void ResetRuntimeState()
    {
        ...
        name = string.Empty; if (imageslot != null) { imageslot.sprite = null; }
        SetSelectedVisual(false);
    }
    ...
    private void CacheDefaultBackgroundColor()
    {
        ...
        defaultBackgroundColor = background.color; hasCachedDefaultBackgroundColor = true;
    }
}
