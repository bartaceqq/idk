...
public class PlayerRootMotionDriver : MonoBehaviour
{
    ...
    {
        if (!ResolveReferences() || animator == null || !animator.applyRootMotion ||
        actionScript == null || !actionScript.ShouldConsumeAnimatorRootMotion()) { return; }
        ...
        if (!IsNearlyZero(deltaPosition))
        {
            ...
            else { targetRoot.position += deltaPosition; }
        }
    ...
    private bool ResolveReferences()
    {
        ...
        ? characterController.transform : transform.parent != null ? transform.parent
        : transform.root;
        }
