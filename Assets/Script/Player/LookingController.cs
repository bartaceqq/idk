...
public class LookingController : MonoBehaviour
{
    ...
    public bool switched = false; public Animator animator; public GameObject normalcapsule;
    public GameObject buildingcapsule; public Transform position;
    public Transform normalLookTransform; public Transform buildingLookTransform;
    private void Start() { SyncSwitchStateFromActiveCapsule(); }
    private void Update()
    {
        bool uiBlocking = GameplayUiState.IsGameplayInputBlocked;
        GameplayUiState.ApplyCursorState(); if (uiBlocking) { return; }
    ...
    public void Switch()
    {
        ...
        SyncSwitchStateFromActiveCapsule(); bool switchToBuilding = !switched;
        ...
        sourceCapsule.SetActive(false); targetCapsule.SetActive(true);
        switched = switchToBuilding; if (switched)
        {
            if (animator != null) animator.enabled = false;
        }
        else { if (animator != null) animator.enabled = true; }
    ...
    {
        SyncSwitchStateFromActiveCapsule(); if (switched) { return; }
        Switch();
    }
    ...
    private void SyncSwitchStateFromActiveCapsule()
    {
        ...
        if (normalActive && !buildingActive) { switched = false; return; }
